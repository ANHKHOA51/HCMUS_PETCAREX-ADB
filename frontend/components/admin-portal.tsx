  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-bold text-3xl text-foreground">Admin Dashboard</h2>
          <p className="text-muted-foreground">Revenue analytics and system management</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="font-bold text-2xl">${totalRevenue.toLocaleString()}</div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
            ...
            <div className="mt-4 space-y-2">
              {serviceRevenueData.map((service, index) => (
                <div key={service.name} className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-muted-foreground">${service.amount.toLocaleString()}</span>
                </div>
              ))}
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Revenue comparison between branches</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
