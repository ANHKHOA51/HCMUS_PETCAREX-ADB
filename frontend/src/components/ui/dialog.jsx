...
export const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        ref={ref}
        className={twMerge("relative z-50 w-full max-w-lg bg-white rounded-lg shadow-lg p-6 mx-4", className)}
        {...props}
      >
        {children}
...
export const DialogTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h2 ref={ref} className={twMerge("text-lg font-semibold leading-none tracking-tight", className)} {...props} />
))
