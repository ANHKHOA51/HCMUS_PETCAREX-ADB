    ...
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your pet profiles and book appointments</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-xl border-2 border-dashed border-gray-300">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">No pets registered yet</h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-2xl font-bold text-gray-900">{editingPet ? "Edit Pet" : "Register New Pet"}</h2>
            </div>
