...
IF EXISTS (SELECT name FROM sys.indexes WHERE name = N'IX_HOADON_TrangThai_Active')
BEGIN
    DROP INDEX IX_HOADON_TrangThai_Active ON HOADON;
END 
GO
...
PRINT '=== TEST 1: IX_HOADON_TrangThai_Active - WITHOUT INDEX ===';
