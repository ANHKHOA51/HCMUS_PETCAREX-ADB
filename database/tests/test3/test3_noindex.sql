...
IF EXISTS (SELECT name FROM sys.indexes WHERE name = N'IX_HOSOBENHAN_NgayTaiKham')
BEGIN
    DROP INDEX IX_HOSOBENHAN_NgayTaiKham ON HOSOBENHAN;
END 
GO
...
PRINT '=== TEST 3: IX_HOSOBENHAN_NgayTaiKham - WITHOUT INDEX ===';
