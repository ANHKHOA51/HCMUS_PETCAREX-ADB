...
IF EXISTS (SELECT name FROM sys.indexes WHERE name = N'IX_CHITIETHOADON_BANLE_MaSanPham')
BEGIN
    DROP INDEX IX_CHITIETHOADON_BANLE_MaSanPham ON CHITIETHOADON_BANLE;
END 
GO
...
PRINT '=== TEST 5: IX_CHITIETHOADON_BANLE_MaSanPham - WITHOUT INDEX ===';
